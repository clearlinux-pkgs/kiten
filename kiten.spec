...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/kiten-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/kiten-24.05.2.tar.xz.sig
...
%setup -q -n kiten-24.05.2
cd %{_builddir}/kiten-24.05.2
pushd ..
cp -a kiten-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720581853
mkdir -p clr-build
pushd clr-build
