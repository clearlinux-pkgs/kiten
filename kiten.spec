...
Version  : 22.04.1
Release  : 41
URL      : https://download.kde.org/stable/release-service/22.04.1/src/kiten-22.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/kiten-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/kiten-22.04.1.tar.xz.sig
...
%prep
%setup -q -n kiten-22.04.1
cd %{_builddir}/kiten-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652648956
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kiten-22.04.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kiten/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kiten-22.04.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kiten/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kiten-22.04.1/LICENSES/GPL-1.0-or-later.txt %{buildroot}/usr/share/package-licenses/kiten/e154343fcf8229d714c82906b31df9822fd08ebf
cp %{_builddir}/kiten-22.04.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kiten/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kiten-22.04.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kiten/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/kiten-22.04.1/data/font/KanjiStrokeOrders.ttf.license %{buildroot}/usr/share/package-licenses/kiten/4fe1019be678bc440c6c4a703d34fd4dd77bfd56
pushd clr-build
%make_install
popd
%find_lang kiten
