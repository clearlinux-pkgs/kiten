...
Version  : 20.12.1
Release  : 28
URL      : https://download.kde.org/stable/release-service/20.12.1/src/kiten-20.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/kiten-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/kiten-20.12.1.tar.xz.sig
...
%prep
%setup -q -n kiten-20.12.1
cd %{_builddir}/kiten-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610047294
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kiten-20.12.1/COPYING %{buildroot}/usr/share/package-licenses/kiten/b17021ddf3069644265ecd0db9641bb11ce73e66
cp %{_builddir}/kiten-20.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kiten/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kiten-20.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kiten/c08668a6ace9b36ba46940609040748161b03a37
cp %{_builddir}/kiten-20.12.1/data/font/copyright.txt %{buildroot}/usr/share/package-licenses/kiten/e7547262e8641ad3ee1baf95d91546da82b6b47b
pushd clr-build
%make_install
popd
%find_lang kiten
